// src/components/anella/GiftPersonalization.tsx
'use client';
...
export function GiftPersonalization() {
  ...
  return (
    <section id="personalization" className="container mx-auto px-4 py-16 bg-secondary/30 rounded-lg my-16">
